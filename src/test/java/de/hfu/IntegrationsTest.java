...
public class IntegrationsTest {
    ...
    public void getUniqueResidentsTest() throws ResidentServiceException {
        ...
        assertEquals(r2.getStreet(), result2.getStreet());
            ...
            list.add(new Resident("Max", "Mustermann", "Musterstraße", "Musterstadt", new Date()));
            list.add(new Resident("Martina", "Mustermann", "Albertstraße", "Musterdorf", new Date()));
            ...
            List<Resident> result = rs.getFilteredResidentsList(new Resident("Ma*", "Mu*", "*straße", "Muster*", new Date()));
            ...
            assertEquals("Albertstraße", result.get(1).getStreet());
            ...
            try {
            Resident result = rs.getUniqueResident(new Resident("Martina", "Mustermann", "Albertstraße", "Musterdorf", null));
