...
public class IntegrationsTest {
	...
	public void testGetFilteredResidentsList3() {
		...
		List<Resident> result = rs
				.getFilteredResidentsList(new Resident("Ma*", "Mu*", "*straße", "Muster*", new Date()));
	...
	public void testGetUniqueResident1() {
		...
		try {
			Resident result = rs
					.getUniqueResident(new Resident("Martina", "Mustermann", "Albertstraße", "Musterdorf", null));
